...
QUALIFY row_number() OVER (PARTITION BY  TRANSACTION_ID , TRANSACTION_DATE ORDER BY  TRANSACTION_TIME DESC) = 1
...
QUALIFY row_number() OVER (PARTITION BY order_id ORDER BY CASE WHEN METADATA$ACTION  ='INSERT' THEN 0 ELSE 1 END , order_date desc) = 1)
as source
...
--=============================================================================================================================================================================================
-- CREATING TASK FOR IOT TABLE WITH CDC MERGE STATEMENT HANDLING DUPLICATED VALUES 
--=============================================================================================================================================================================================
