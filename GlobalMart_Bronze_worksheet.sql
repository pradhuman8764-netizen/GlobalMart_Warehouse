...
CREDENTIALS = (
AWS_KEY_ID = 'AKIA527J7865VNFPDEKJ5AIMI'
AWS_SECRET_KEY = 'F2fO7MB876491/1J9vMZkbDr5OfvgINXEDymJME0teaB3W'
...
--=============================================================================================================================================================================================
create or replace table raw_IoT (row_col variant) DATA_RETENTION_TIME_IN_DAYS = 14 ;
...
CREATE OR REPLACE TABLE raw_erp_data (parquet_raw VARIANT) DATA_RETENTION_TIME_IN_DAYS = 14 ;
--=============================================================================================================================================================================================
